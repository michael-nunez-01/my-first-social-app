...
export default function WritingView({route, navigation}) {
  ...
  const hasPrefilledRecipient = route.params?.receivingUser !== undefined;
  ...
  if (hasPrefilledRecipient)
    navigation.setOptions({title: 'To '+receivingUser.displayName+':'});
  ...
  return (
    <View style={{flex: 1, justifyContent: 'space-between'}}>
      <SearchableDropdown
        ...
        textInputProps={{
          editable: hasPrefilledRecipient
            ? false
            : true,
          defaultValue: hasPrefilledRecipient
